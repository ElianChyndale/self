...
export const BUNDLED_INTEL_ARTICLES: NewsArticle[] = [
  {
...
export const BUNDLED_INTEL_CONTENT: Record<string, string> = {
...
export function getBundledIntelArticleContent(link: string): string | null {
  return BUNDLED_INTEL_CONTENT[link] || null;
}
